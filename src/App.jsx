        ...
        <div className="screen timeline-screen">
          <div className="terminal-box">
            ...
            <p className="terminal-text" style={{ fontStyle: 'italic', marginBottom: '2rem', opacity: 0.8 }}>
              ...
              Started dating on 11 January and 13 January.
            </p>
      ...
      {screen === 'final-reveal' && (
        <div className="screen final-screen">
          <div className="fade-in">
            ...
            <p className="final-text">The way you call and interrupt whatever I'm doing. And I pause it every time. Because your voice is all I need to hear.</p>
